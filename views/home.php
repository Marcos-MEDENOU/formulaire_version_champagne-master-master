...
<body>
    <header>
        <div class="block_header">
            ...
            <div class="block_header_right">
                ...
                <div id="con-decon">
                    <ul>
                        <li><a href="Sig_in.php">Sign in</a></li>
                        <li><a href="sig_up.php">Sign Up</a></li>
                    </ul>
                    <div class="connect">
                        <span>               
                            <svg width="35px" xmlns="http://www.w3.org/2000/svg" fill="white" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" />
                            </svg> <?php echo $_SESSION['username'];?> 
                            <svg width="30px" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                            ...
                            <nav>
                                <ul>
                                    <li>Profil</li>
                                    <li>Réglages</li>
                                    <li><a href="Sig_in.php">Deconnexion</a> </li>
                                </ul>
                            </nav>                   
                        </span>
                    </div>
    ...
    <main>
        ...
        <div class="JScode_and_text">
            <div class="text-left">
                <p>Un éditeur de code puissant mis a votre disposition pour tester vos solutions</p>
                <button>Tester l'éditeur de code</button>
            </div>
            <img width="500px" src="../asset/images/editor.webp" alt="">
        </div>
        <div class="block_exercices">
            <svg width="700px" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 1000 1000">
                <defs>
            ...
            <div class="text_exercices_and_button">
                <span>Des exercices bien détaillés pour comprendre rapidement les concepts de base</span>
                <button>Commencer les exercices</button>
            </div>
        </div>
        ...
        <div class="sponsoried">
            <div class=".animation-ctn">
                <div class=" icon--order-success icon svg">
                    <svg class="svg_validate" xmlns="http://www.w3.org/2000/svg" width="150px" height="150px">
                        <g fill="none" stroke="transparent" stroke-width="1">
            ...
            <img width="200px" height="200px" src="../asset/images/logo2.png" alt=""> <br>
    ...
    <script>
        let i = 0;
        let txt = "Learn JS, Une plateforme complete pour apprendre facilement le javaScript.";
